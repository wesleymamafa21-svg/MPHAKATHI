...
const SOSModal: React.FC<SOSModalProps> = ({ isOpen, onClose, contacts, simulatedUsers, onSend, location, userName }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            const locationInfo = location
                ? `My location has been attached to this alert: https://www.google.com/maps?q=${location.latitude},${location.longitude}`
