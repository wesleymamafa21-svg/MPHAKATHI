...
const PinManager: React.FC<{onSetPin: (pin: string) => void; pinIsSet: boolean}> = ({ onSetPin, pinIsSet }) => {
    ...
    return (
        <div className="w-full bg-gray-800/50 p-6 rounded-lg mb-6">
            ...
            <p className="text-gray-400 mb-4">A 4-digit PIN is required to deactivate a session. This is a safety feature to prevent accidental or unauthorized deactivation.</p>
            <div className="flex flex-col gap-4">
                <input 
                    ...
                    className="w-full bg-gray-900 border border-gray-600 rounded-md p-2 text-white focus:ring-2 focus:ring-yellow-500 text-center text-xl tracking-widest"
                    maxLength={4}
                    pattern="\d{4}"
                    inputMode="numeric"
        ...
        <div className="w-full max-w-4xl flex flex-col items-center p-4 animate-fade-in">
            <div className="w-full flex justify-between items-center mb-6">
             ...
             <div className="w-full bg-gray-800/50 p-6 rounded-lg mb-6">
                ...
                <label htmlFor="userName" className="block text-gray-300 mb-2">Your Name (for alerts)</label>
                <input 
                    id="userName"
                    type="text" 
                    ...
                    className="w-full bg-gray-900 border border-gray-600 rounded-md p-2 text-white focus:ring-2 focus:ring-yellow-500"
                />
            </div>
            ...
            <div className="w-full bg-gray-800/50 p-6 rounded-lg mb-6">
                ...
                {user.gender ? (
                    <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => handleGenderSelect(null)} className="text-sm bg-gray-700 hover:bg-gray-600 px-3 py-1 rounded-full transition-colors">Change</button>
                    </div>
                ) : (
                    <div>
                        <p className="mb-3 text-gray-300">Select an identity for tailored safety tips:</p>
                        <div className="flex justify-center gap-2 flex-wrap">
                            {(Object.keys(Gender) as Array<keyof typeof Gender>).map(key => (
                                <button
                                    key={key}
                                    onClick={() => handleGenderSelect(Gender[key])}
                                    className="px-4 py-2 bg-gray-700 hover:bg-yellow-500 hover:text-black rounded-full transition-colors">
                                    {Gender[key]}
                                </button>
                            ))}
                        </div>
            ...
            <div className="w-full bg-gray-800/50 p-6 rounded-lg mb-6">
                <h3 className="text-xl font-semibold text-yellow-400 mb-2">🤫 Voice Secret Code</h3>
                 ...
                 <button
                    ...
                    className="w-full px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-full transition-colors font-semibold"
                >
            ...
            <div className="w-full bg-gray-800/50 p-6 rounded-lg mb-6">
                 ...
                 <p className="text-gray-300 mb-3">Choose the tone for calming messages when stress is detected:</p>
                 <div className="flex justify-center gap-2 flex-wrap">
            ...
            <div className="w-full bg-gray-800/50 p-6 rounded-lg mb-6">
                ...
                {user.isSurvivor && (
                     <p className="text-sm text-yellow-300 bg-yellow-900/50 p-3 rounded-md mb-4 border border-yellow-700">
            ...
            <div className="w-full bg-gray-800/50 p-6 rounded-lg mb-6">
                ...
                <div className="pt-4 border-t border-gray-700">
                    <h4 className="font-semibold text-gray-200 mb-2">Safety Check-in Interval</h4>
                    <p className="text-xs text-gray-400 mb-3">Mphakathi will periodically ask if you are safe. Select how often.</p>
                    <div className="flex justify-center gap-2 flex-wrap">
                ...
                <div className="pt-4 mt-4 border-t border-gray-700">
                    <h4 className="font-semibold text-gray-200 mb-2">Voice Secret Code Reminder</h4>
                    <p className="text-xs text-gray-400 mb-3">Periodically get a reminder of your secret phrase. Useful if you've recently set or changed it.</p>
                    <div className="flex justify-center gap-2 flex-wrap">
